...
public class BookingApplicationServiceImpl implements BookingApplicationService {
    ...
    @Override
    public Optional<DisplayBookingDTO> create(CreateBookingDTO createBookingDTO) throws Exception {
        ...
        return this.bookingDomainService.create(booking)
    ...
    public Optional<DisplayBookingDTO> update(Long ID, CreateBookingDTO createBookingDTO) throws Exception {
        ...
        return this.bookingDomainService.update(ID, createBookingDTO.toBooking(host_obj))
                .map(DisplayBookingDTO::from);
    }
