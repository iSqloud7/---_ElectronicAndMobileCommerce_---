...
public class BookingRestController {
    ...
    public ResponseEntity<Optional<DisplayBookingDTO>> addBooking(@RequestBody CreateBookingDTO createBookingDTO) throws Exception {
        return ResponseEntity.ok(this.bookingApplicationService.create(createBookingDTO));
    }

    @PutMapping("/edit-booking/{ID}")
    @PreAuthorize("hasRole('HOST')")
    public ResponseEntity<Optional<DisplayBookingDTO>> editBooking(@PathVariable Long ID,
    ...
    public ResponseEntity<Optional<Booking>> reservation(@PathVariable Long ID) throws Exception {
