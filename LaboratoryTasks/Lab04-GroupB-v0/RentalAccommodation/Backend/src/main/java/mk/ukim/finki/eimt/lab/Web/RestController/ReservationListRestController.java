...
public class ReservationListRestController {
    ...
    private final ReservationListDomainService reservationListService;

    public ReservationListRestController(ReservationListDomainService reservationListService) {
